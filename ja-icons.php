<?php
/**
 * JourneyAI — inline SVG icon set (professional line icons, no emojis).
 * Usage:  <?= ja_icon('compass') ?>   or  <?= ja_icon('compass', 28) ?>
 * Icons inherit currentColor. Stroke-based (Feather-style), 1.8 weight.
 */
function ja_icon($name, $size = 20, $extra = '') {
    $p = [
        ...
        'gem'       => '<polygon points="6 3 18 3 22 9 12 22 2 9"/><path d="M12 22 7 9l5-6"/><path d="M12 22l5-13-5-6"/><path d="M2 9h20"/>',
